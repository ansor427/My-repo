...
// data types
// let nama = "Muhamad Ansor"; // string
// let age = 20; // number
// let isMarried = false; // bool/boolean

// nama saya Abel Dustin umur saya 25 tahun
// console.log("nama saya Muhamad Ansor umur saya 20 tahun"); // cara 1 - basic
...
function submitData() {
    ...
    let emailReceiver = "ansormuhamad325@gmail.com";
